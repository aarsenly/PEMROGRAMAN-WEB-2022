...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 22, 2022 at 03:30 PM
...
CREATE TABLE `dbaslab` (
  ...
  `nama_aslab` varchar(20) NOT NULL,
  `nim_aslab` varchar(11) NOT NULL,
  `no_aslab` varchar(13) NOT NULL,
...
INSERT INTO `dbaslab` (`id_aslab`, `nama_aslab`, `nim_aslab`, `no_aslab`, `keterangan`) VALUES
(1, 'Putrie Aurelia Riyon', '19090760200', '081213141516', 'Asisten Basis Data'),
(2, 'Alya Arsenly', '1909076020', '082223242526', 'Asisten Basis Data'),
(3, 'Muhammad Arya Delwiz', '1909076026', '083233343536', 'Asisten Struktur Data'),
(4, 'Siska Mayra Andini', '1909076027', '084243444546', 'Asisten Struktur Data');
...
(7, 'Felixiano Halim', '20009076033', '2'),
...
(1, 'Aprillia Amrina Ainurrosyida', '1909076016', '1'),
(2, 'Ahmad Akbar ', '1909076003', '1'),
(3, 'Eki Rian Cavalera', '1909076028', 'tidak mengikuti'),
(4, 'Chandra Bayuaji', '2009076030', '1'),
(5, 'Mahesa Adskhan Al-Aqsa', '2009076031', '1'),
(6, 'Calvin Antares', '2009076032', '2'),
(7, 'Felixiano Halim', '20009076033', '2'),
